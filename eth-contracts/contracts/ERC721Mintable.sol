...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(msg.sender == _owner, "Owner Authorized Only.");
        _;
    }
...
contract Pausable is Ownable {
    ...
    modifier paused() {
        require(_paused == true, "Contract is currently Unpaused.");
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner, "Approval Address cannot to be set to owner of the tokenId.");
        require(msg.sender == owner || isApprovedForAll(owner, msg.sender), "Not Authorized to approve another address for given token Id.");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "Invalid Token Owner.");
